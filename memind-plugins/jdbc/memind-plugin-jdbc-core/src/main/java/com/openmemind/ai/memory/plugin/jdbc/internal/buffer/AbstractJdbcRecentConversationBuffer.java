...
public abstract class AbstractJdbcRecentConversationBuffer implements RecentConversationBuffer {

    private final AbstractJdbcConversationBufferAccessor accessor;

    protected AbstractJdbcRecentConversationBuffer(
            AbstractJdbcConversationBufferAccessor accessor) {
