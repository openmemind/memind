...
public final class PostgresqlJdbcPlugin {
    ...
    public static JdbcMemoryAccess create(DataSource dataSource, JdbcPluginOptions options) {
        ...
        var insightBufferStore =
                new PostgresqlInsightBuffer(dataSource, options.createIfNotExist());
        var conversationBufferAccessor =
                new PostgresqlConversationBufferAccessor(dataSource, options.createIfNotExist());
        var bubbleTrackerStore =
                new PostgresqlBubbleTrackerStore(dataSource, options.createIfNotExist());
        var memoryBuffer =
                MemoryBuffer.of(
                        insightBufferStore,
