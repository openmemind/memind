 ...
 */
package com.openmemind.ai.memory.plugin.store.mybatis.textsearch.postgresql;
...
public class PostgresqlTrigramTextSearch extends AbstractJdbcMemoryTextSearch {
    ...
    public PostgresqlTrigramTextSearch(JdbcTemplate jdbcTemplate) {
        super(jdbcTemplate);
    }
