...
@Mapper
public interface MemoryGraphAliasBatchReceiptMapper
        extends BaseMapper<MemoryGraphAliasBatchReceiptDO> {

    @InsertProvider(
            type = ItemGraphMutationSqlProvider.class,
            method = "insertAliasBatchReceiptIfAbsent")
    int insertIfAbsent(
            @Param("receipt") MemoryGraphAliasBatchReceiptDO receipt,
