...
@AutoConfiguration
@ConditionalOnClass(AgentRawDataPlugin.class)
@EnableConfigurationProperties(AgentRawDataProperties.class)
@ConditionalOnProperty(
        prefix = "memind.rawdata.agent",
        name = "enabled",
        havingValue = "true",
        matchIfMissing = true)
public class AgentRawDataAutoConfiguration {
