...
public abstract class AbstractJdbcGraphOperations implements GraphOperations {
    ...
    private List<GraphEntity> queryList(
            String sql, JdbcExecutor.RowMapper<GraphEntity> mapper, Object... params) {
        return JdbcExecutor.queryList(dataSource, sql, mapper, params);
    }
    ...
    private static <T> List<T> queryList(
            Connection connection, String sql, JdbcExecutor.RowMapper<T> mapper, Object... params) {
