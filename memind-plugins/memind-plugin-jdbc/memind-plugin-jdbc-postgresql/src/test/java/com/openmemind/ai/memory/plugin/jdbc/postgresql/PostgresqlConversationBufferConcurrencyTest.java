...
class PostgresqlConversationBufferConcurrencyTest {
    ...
    void concurrentDrainClaimsPreexistingBatchOnce() throws Exception {
        ...
        String sessionId = "postgres-concurrent-user:agent";
        int messageCount = 20;
        PostgresqlConversationBuffer seedBuffer = new PostgresqlConversationBuffer(dataSource);
        ...
        var first =
                new PostgresqlConversationBuffer(
        ...
        assertThat(new PostgresqlRecentConversationBuffer(dataSource).loadRecent(sessionId, 100))
    ...
    private static List<List<Message>> drainConcurrently(
            PostgresqlConversationBuffer first,
            PostgresqlConversationBuffer second,
            String sessionId)
            throws Exception {
    ...
    private static List<Message> drainAfterBarrier(
            PostgresqlConversationBuffer buffer, String sessionId, CyclicBarrier startBarrier) {
    ...
    private static final class BlockingSelectAccessor extends PostgresqlConversationBufferAccessor {
