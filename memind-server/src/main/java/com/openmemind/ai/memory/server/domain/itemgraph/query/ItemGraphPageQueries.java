 ...
 */
package com.openmemind.ai.memory.server.domain.itemgraph.query;
...
public final class ItemGraphPageQueries {
    ...
    public record AliasPageQuery(
            int pageNo, int pageSize, String memoryId, String entityKey, String q) {}
    ...
    public record BatchPageQuery(int pageNo, int pageSize, String memoryId, String state) {}
}
