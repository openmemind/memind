...
@RestController
@RequestMapping("/admin/v1/alerts")
public class AdminAlertsController {

    private final DashboardQueryService queryService;

    public AdminAlertsController(DashboardQueryService queryService) {
        this.queryService = queryService;
    }

    @GetMapping("/summary")
    public SuccessResult<AdminAlertsSummaryView> summary() {
        return new SuccessResult<>(queryService.alertsSummary());
    }
}
