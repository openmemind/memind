...
/**
 * Semantic item relation with explicit evidence channel.
 */
public record SemanticItemRelation(
        long sourceItemId,
        long targetItemId,
        SemanticEvidenceSource evidenceSource,
        double strength)
        implements ItemGraphRelation {

    public SemanticItemRelation {
