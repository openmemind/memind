...
public final class HashUtils {
     ...
     *
     * <p>Small text (≤2KB) uses the complete hash; large text takes the first 1KB + last 1KB + length
     * to generate the hash, avoiding traversing the entire text. Returns 16-bit hex.
     *
     * @param content The content to calculate the hash for
