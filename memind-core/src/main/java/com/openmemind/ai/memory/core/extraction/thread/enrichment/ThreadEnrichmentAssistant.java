...
/**
 * Optional write-side assistant that proposes replay-safe thread enrichment outputs.
 */
public interface ThreadEnrichmentAssistant {

    Mono<List<ThreadEnrichmentResult>> enrich(
