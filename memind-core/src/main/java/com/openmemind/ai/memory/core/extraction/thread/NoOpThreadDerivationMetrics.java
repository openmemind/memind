...
/**
 * No-op metrics implementation for default wiring.
 */
public final class NoOpThreadDerivationMetrics implements ThreadDerivationMetrics {

    public static final NoOpThreadDerivationMetrics INSTANCE = new NoOpThreadDerivationMetrics();

    private NoOpThreadDerivationMetrics() {}
