...
/**
 * Deep retrieval strategy (two-layer drilling + BM25 probing + type-based routing + single-level RRF + integrated Rerank + rawDataId aggregation)
 *
 * <p>Process:
 * <ol>
...
public class DeepRetrievalStrategy implements RetrievalStrategy {
    ...
    /**
     * Continue Tier2 pipeline: determine strong signal → expand channel routing → single-level RRF → rawDataId aggregation → Rerank → second round
     */
