...
/**
 * Causal item relation with explicit subtype.
 */
public record CausalItemRelation(
        long sourceItemId, long targetItemId, CausalRelationCode relationCode, double strength)
        implements ItemGraphRelation {

    public CausalItemRelation {
