...
/**
 * Disabled-mode memory-thread persistence implementation.
 */
public final class NoOpMemoryThreadOperations implements MemoryThreadOperations {

    public static final NoOpMemoryThreadOperations INSTANCE = new NoOpMemoryThreadOperations();

    private NoOpMemoryThreadOperations() {}
